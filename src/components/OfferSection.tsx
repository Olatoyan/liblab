  ...
  return (
    <section className="bg-[#151b22] py-32 px-0 relative">
      ...
      <img
        ...
        alt="TypeScript"
        className="absolute w-[70px] desktop:w-[40px] tablet:w-[25px] top-[32%] left-[10%] desktop:left-[5%] tablet:top-[58%] mobile:top-[43%]"
      />
      <img
        src="img/go.webp"
        alt="go"
      ...
      <img
        src="img/python.webp"
        alt="python"
        className="absolute w-[70px] desktop:w-[40px] tablet:w-[25px] top-[46%] right-[20%] desktop:right-[10%] mobile:right-[3%]"
      />

      <img
        src="img/java.webp"
        alt="java"
        className="absolute w-[70px] desktop:w-[40px] tablet:w-[25px] bottom-[20%] left-[20%] mobile:bottom-[12%]"
      />

      <img
        src="img/swift.webp"
        alt="swift"
        className="absolute w-[70px] desktop:w-[40px] tablet:w-[25px] bottom-[28%] right-[2%] mobile:bottom-[15%]"
      />

      <img
        src="img/terra.webp"
        alt="terra"
        className="absolute w-[70px] desktop:w-[40px] tablet:w-[25px] bottom-[5%} left-[40%] mobile:bottom-[9%]"
      />
    </section>
  );
}
